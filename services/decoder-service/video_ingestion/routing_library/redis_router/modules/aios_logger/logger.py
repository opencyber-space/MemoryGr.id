...
root_log_copy = copy.deepcopy(logger)
...
def get_default_config():
    return {
        "service_name": "dag-block-instance",
        "logging_path": lpath,
        "serialize": True,
...
class Logger__internal:
    ...
    def __init__(self, config: dict = None):
        self.logger = copy.deepcopy(root_log_copy)
...
class AIOSLogger:
    ...
    def __init__(self, config=None):
        ...
        self.component_id = os.getenv("COMPONENT_URI", "none")
    ...
    def set_service_name(self, svc_name):
        self.logger.config['service_name'] = svc_name
        self.set_config(self.logger.config)
    ...
    def debug(self, action: str, message: str, extras: dict = {}):

        if not self.debug_enabled:
            return

        extras['action'] = action
        extras['component_id'] = self.component_id
